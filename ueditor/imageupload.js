...
CallBackMethod = {};
CallBackObj = {};
var webuploaderFilePicker = "webuploader-filePicker";
function UploadImageByGarmiter(obj, func) {
    CallBackMethod = func;
    CallBackObj = obj;
    $("#" + webuploaderFilePicker + " input[name=file]").click();
}

$(function () {
    $(document.body).append('<div style="display:none;" id="' + webuploaderFilePicker + '">选择图片</div>');
